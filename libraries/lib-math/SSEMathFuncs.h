...
SSE2 is mandatory in order to use these functions. There might not be any
significant performance gains with SSE2, but since most systems nowadays will
support SSE2, this should be fine.
*/
