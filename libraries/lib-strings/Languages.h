...
/*!
 @param saucedacityPathList paths to search for .mo files, grouped into subdirectories for the different languages
...
STRINGS_API
wxString SetLang( const FilePaths &saucedacityPathList, const wxString & lang );
