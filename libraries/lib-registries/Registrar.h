...
public:
   ...
   bool bWantsEffects;
   virtual void AddCommandType(std::unique_ptr<ComponentInterface> && /* comDef */ ){;};
   virtual void AddCommand(std::unique_ptr<AudacityCommand> && /* command */ ){;};
   virtual void AddModule(std::unique_ptr<LoadableModule> && /* module */ ){;};
