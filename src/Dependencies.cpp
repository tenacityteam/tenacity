...
\brief DependencyDialog shows dependencies of an SaucedacityProject on 
AliasedFile s.
...
static void GetAllSeqBlocks(SaucedacityProject *project,
...
static void RemoveDependencies(SaucedacityProject *project,
