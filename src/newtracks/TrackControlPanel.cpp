...
void TrackControlPanel::AddOption(TranslatableString name, Action action, int id)
{
...
void TrackControlPanel::AddOption(
    TranslatableString name, void(Class::*memberFunction)(EventArg&),
    Handler* handler, int id
)
{
    mTrackOptionsMenu.Append(id, name.Translation());
    Bind(wxEVT_MENU, memberFunction, handler);
}
