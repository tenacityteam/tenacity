...
namespace Registry {
   ...
   // large.
   struct SAUCEDACITY_DLL_API BaseItem {
   ...
   struct SAUCEDACITY_DLL_API SharedItem final : BaseItem {
   ...
   struct SAUCEDACITY_DLL_API ComputedItem final : BaseItem {
   ...
   struct SAUCEDACITY_DLL_API SingleItem : BaseItem {
      using BaseItem::BaseItem;
      ~SingleItem() override = 0;
   };

   // Common abstract base class for items that group other items
   struct SAUCEDACITY_DLL_API GroupItem : BaseItem {
      using BaseItem::BaseItem;
   ...
   class SAUCEDACITY_DLL_API Visitor
   {
   public:
      virtual ~Visitor();
