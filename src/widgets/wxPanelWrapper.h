...
class SAUCEDACITY_DLL_API wxTabTraversalWrapper : public Base
{
public:
...
class SAUCEDACITY_DLL_API wxPanelWrapper : public wxTabTraversalWrapper<wxPanel>
{
public:
   // Constructors
   wxPanelWrapper() {}
...
class SAUCEDACITY_DLL_API wxDialogWrapper : public wxTabTraversalWrapper<wxDialog>
{
public:
   // Constructors
   wxDialogWrapper() {}
...
class SAUCEDACITY_DLL_API wxDirDialogWrapper
...
class SAUCEDACITY_DLL_API FileDialogWrapper
