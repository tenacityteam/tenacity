...
class SAUCEDACITY_DLL_API OverlayPanel /* not final */ : public BackedPanel {
public:
...
struct SAUCEDACITY_DLL_API DCUnchanger {
public:
   DCUnchanger() {}
...
class SAUCEDACITY_DLL_API ADCChanger : public std::unique_ptr<wxDC, ::DCUnchanger>
{
